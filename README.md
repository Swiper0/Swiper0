...
<table style="text-align: center;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="https://github.com/Swiper0/Aim-Zone">Details</a>
      <a href="https://your-website-link-here.com" target="_blank">
        <button style="padding: 8px 16px; background-color: #4CAF50; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: bold;">Play Online</button></a>
      </td>
    </tr>
  </tbody>
</table>
